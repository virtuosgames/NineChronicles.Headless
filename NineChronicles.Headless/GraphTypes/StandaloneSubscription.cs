    ...
    public class StandaloneSubscription : ObjectGraphType
    {
        ...
        public StandaloneSubscription(StandaloneContext standaloneContext)
        {
            ...
            AddField(new EventStreamFieldType
            {
                ...
                Subscriber = new EventStreamResolver<MonsterCollectionState>(context => standaloneContext.MonsterCollectionStateSubject
            ...
            AddField(new EventStreamFieldType
            {
                ...
                Subscriber = new EventStreamResolver<MonsterCollectionStatus>(context => standaloneContext.MonsterCollectionStatusSubject
